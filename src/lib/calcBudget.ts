...
// Map materialId -> SINAPI insumo key
const materialIdToSinapiKey: Record<string, string> = {
  ...
  'ceramica_parede': 'REVEST_M2', 'ceramica_piso': 'REVEST_M2', 'ceramica_piso_antiderrap': 'REVEST_M2', 'ceramica_piso_ext': 'CER_EXT_M2',
  'rev_pisc': 'REVEST_M2', 'piso_ext_m2': 'CER_EXT_M2',
  ...
  'telha_fibro': 'TELHA_FIBRO_M2', 'telha_ceram': 'TELHA_CERAM_M2',
  'forro_pvc_material': 'PVC_FORRO_M2',
  'gesso_placa': 'GESSO_M2', 'perfil_met_gesso': 'PERFIL_MET_M',
  'drywall_placa': 'DRYWALL_M2', 'perfil_met_drywall': 'PERFIL_MET_M',
...
export function calcBudget(inputs: ProjectInputs, derived: DerivedVars): BudgetResult {
  // BDI: only manual, default 0
  const bdiPct = (inputs.bdiManual_pct ?? 0) / 100;
  ...
  return {
    items, byGroup,
    subtotalComMaterial, subtotalSemMaterial,
    bdiPct, bdiValorComMat, bdiValorSemMat,
    totalComMaterial, totalSemMaterial,
